            ...
            <div class="auth-content">
                <div class="text-left mb-0">
                    <a href="{{ url('/') }}" class="d-inline-block">
                        <img src="{{ asset('assets/images/favicon_arjuna/android-chrome-512x512.png') }}" alt="Arjuna Trans Logo" class="auth-logo" width="60" height="60">
                    </a>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="d-grid gap-2 mt-4">
                        <button type="submit" class="btn btn-primary" title="Klik untuk login">
                            Log in
                        </button>
                    </div>
                </form>
