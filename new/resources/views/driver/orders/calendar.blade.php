    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Jadwal Saya</h4>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="me-3 mb-2 mb-md-0">
                                <label for="vehicle-filter" class="me-2">Armada</label>
                                <select id="vehicle-filter" class="form-select form-select-sm" style="width: 150px; display: inline-block;">
                                    <option value="">Semua</option>
                                    @foreach ($vehicles->where('status', 'ready') as $vehicle)
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                @foreach ($vehicles->where('status', 'ready')->pluck('type')->unique() as $type)
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card border shadow-none mb-3">
                                <div class="card-header bg-soft-success">
                                    <h6 class="card-title mb-0">Informasi Kendaraan</h6>
                                </div>
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-md-5">
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let vehicleFilter = document.getElementById('vehicle-filter');
            ...
            function getEvents() {
                ...
                let url = "{{ route('driver.orders.calendar') }}";
                let params = [];
            ...
            const calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    fetch(url, {
                        ...
                        .catch(error => {
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'Error',
                                text: 'Gagal memuat data kalender. Silakan coba lagi nanti.',
                ...
                eventClick: function(info) {
                    // Fetch detailed order data
                        ...
                        const detailUrl = "{{ route('driver.orders.detail', ['order' => ':id']) }}".replace(':id', eventId);
                        fetch(detailUrl, {
                            method: 'GET',
                            headers: {
                                'Accept': 'application/json',
                        ...
                        .catch(error => {
                            ...
                            document.getElementById('modal-phone').textContent = info.event.extendedProps.phone || '-';
                ...
                eventDidMount: function(info) {
                    ...
                    const tooltip = new bootstrap.Tooltip(info.el, {
                        title: `${info.event.extendedProps.customer || ''} - ${info.event.extendedProps.destination || ''}`,
                        placement: 'top',
                        trigger: 'hover',
                        container: 'body',
                        html: true,
                        template: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner small text-start p-2"></div></div>'
                    });
                }
            });
            ...
            vehicleFilter.addEventListener('change', function() {
                try {
                    ...
                    console.error('Error refreshing events after vehicle filter change:', error);
                }
            });
