                ...
                <div class="card-body">
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <h5 class="mb-3 mt-4">Driver</h5>
                            <div class="mb-3">
                                @if($order->driver)
                                    <p>{{ $order->driver->user->name }}</p>
                                    <p><strong>Telepon:</strong> {{ $order->driver->phone_number }}</p>
                                    <p><strong>Status:</strong> 
                                        @if($order->driver->status == 'active')
                                ...
                                @else
                                    <p class="text-muted">Belum ada driver yang ditugaskan</p>
                                @endif
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <table class="table table-borderless">
                                        ...
                                        <tr>
                                            <th>Sisa Bayar</th>
                                            <td>Rp {{ number_format($order->remaining_cost, 0, ',', '.') }}</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
