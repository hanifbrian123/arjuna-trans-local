            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('orders.store') }}" method="POST">
                            ...
                            <div class="col-lg-9">
                                <select id="vehicleTypeSelect" name="vehicle_type" class="form-select @error('vehicle_type') is-invalid @enderror" data-choices required>
                                    ...
                                    @foreach ($vehicles as $vehicle)
                                        <option value="{{ $vehicle->type }}" {{ old('vehicle_type') == $vehicle->type ? 'selected' : '' }}>{{ $vehicle->type }} - {{ $vehicle->capacity }} Seat</option>
                                    @endforeach
                                </select>
                                @error('vehicle_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-lg-9">
                                <select id="driverNameSelect" name="driver_name" class="form-select @error('driver_name') is-invalid @enderror" data-choices required>
                                    ...
                                    @foreach ($drivers as $driver)
                                        <option value="{{ $driver->user->name }}" {{ old('driver_name') == $driver->user->name ? 'selected' : '' }}>{{ $driver->user->name }}</option>
                                    @endforeach
                                </select>
                                @error('driver_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <!-- Status Pemesanan (hidden for create, default to waiting) -->
